          ...
          return ListView.builder(
              ...
              itemBuilder: (context, position) {
                return GestureDetector(
                  ...
                  // onTap: () => populateFields(snapshot.data![position]),
                  onTap: () {
                    //Get.toNamed(Routes.STUDENTUPDATEEDIT, arguments: snapshot.data![position]);
                    Get.to(StudentUpdateEditPage(),arguments: snapshot.data![position]);
                    print('-------------');
                    print("传入的参数${snapshot.data![position].studentid + snapshot.data![position].sname}");
                    print('-------------');
                  },
                  child: Column(
                    children: <Widget>[
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(
                                      snapshot.data![position].studentid
                                          .toString(),
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Colors.white,
