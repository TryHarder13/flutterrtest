...
import 'package:flutterrtest/test/pageversion1/page/minepage/mine_info.dart';
import 'package:flutterrtest/test/pageversion1/page/minepage/mine_modle.dart';

void main() {
  runApp(SCLMineInfo());
}

class SCLMine extends StatelessWidget {
  List commonUseList = SCLMineModel.commonUseList;
  List mineList = SCLMineModel.mineList;

  List<Widget> getCommonUseCellList(BuildContext context) {
    List<Widget> listViews = <Widget>[];
    for (SCLMineModel model in commonUseList) {
  ...
  List<Widget> getMineCellList(BuildContext context) {
    List<Widget> listViews = <Widget>[];
    for (SCLMineModel model in mineList) {
      listViews.add(cell(model, context));
    }
  ...
  Widget cell(SCLMineModel model, BuildContext context) {
    return Expanded(
        child: InkWell(
            onTap: () {
